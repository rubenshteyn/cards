    ...
    <div class="container-fluid d-flex flex-stack">
      ...
      <div class="d-flex align-items-center me-5">
        ...
        <router-link to="/" class="p-0">
          <img alt="Logo" src="../assets/media/logo.png" class="h-25px h-lg-30px"/>
        </router-link>
        <!--end::Logo-->
      ...
      <div class="d-flex align-items-center flex-shrink-0 topbar-user-profile">
        <div class="right-links d-flex align-items-center ms-1">
          <router-link class="app-bar-item" v-if="!loggedIn" @click.prevent to="/login">Войти
          </router-link>
          <!--begin::User-->
          <div @click='isHidden = !isHidden' v-else class="d-flex align-items-center ms-1">
            ...
            <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3"
              ...
              <div class="symbol symbol-30px symbol-md-40px">
                <img src="@/assets/media/001-boy.svg" alt="image"/>
              </div>
              <!--end::Symbol-->
            </div>
            <!--end::User info-->
      ...
      <div class="hover-scroll-overlay-y my-5 pe-4 me-n4" id="kt_aside_menu_wrapper" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_aside_menu" data-kt-menu="true">
          ...
          <div class="menu-item menu-accordion">
            ...
            <!--begin:Menu item-->
            <div class="menu-item">
              <router-link @click="this.isOpen = false" to="/cards" class="menu-link">
												<span class="menu-icon">
													<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
													<span class="svg-icon svg-icon-2 text-gray-400">
            ...
            <!--begin:Menu item-->
            <div class="menu-item">
                  <router-link @click="this.isOpen = false" to="/transactions" class="menu-link">
												<span class="menu-icon">
													<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
													<span class="svg-icon svg-icon-2 text-gray-400">
          ...
          <div @click="isShow = !isShow" :class="{show: isShow}" class="menu-item opacity-menu menu-accordion" style="transform: unset; position: unset">
            ...
            <div @click="isShow = !isShow" :class="{show: isShow}" class="menu-sub menu-sub-accordion">
              <div class="opacity-menu-block">
                ...
                <div class="menu-item">
                  <!--begin:Menu link-->
                  <router-link @click="this.isOpen = false" to="/users" class="menu-link" >
                ...
                <div class="menu-item">
                  <!--begin:Menu link-->
                  <router-link @click="this.isOpen = false" to="/sessions" class="menu-link">
														<span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
														</span>
                ...
                <div class="menu-item">
                  <!--begin:Menu link-->
                  <router-link @click="this.isOpen = false" to="/suppliers" class="menu-link">
														<span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
														</span>
                ...
                <div class="menu-item">
                  <!--begin:Menu link-->
                  <router-link @click="this.isOpen = false" to="/logs" class="menu-link">
														<span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
														</span>
                ...
                <div class="menu-item">
                  <!--begin:Menu link-->
                  <router-link @click="this.isOpen = false" to="/tasks" class="menu-link">
														<span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
														</span>
