...
type User struct {
	...
	FacebookCommission            float64   `gorm:"not null;default:2.8" json:"facebookCommission"`
	FacebookCost                  float64   `gorm:"not null;default:2" json:"facebookCost"`
	...
	FacebookMonthlyMaintenance    float64   `gorm:"not null;default:10" json:"facebookMonthlyMaintenance"`
}
